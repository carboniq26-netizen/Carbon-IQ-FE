...
/* ─────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────── */
const SLUDGE_ENERGY_COLUMNS: ColumnDef[] = [
    { key: 'Reporting Year', label: 'Year', type: 'text' },
    { key: 'Month', label: 'Month', type: 'text' },
    { key: 'STP Plant ID', label: 'STP Plant ID', type: 'text' },
    { key: 'Location', label: 'Location', type: 'text' },
    ...
    { key: 'Emissions from STP sludge in KgCO2e', label: 'Sludge Emissions', type: 'numeric', showInCard: false, unit: 'kg CO₂e' },
...
const SLUDGE_ENERGY_COMPUTE_FIELDS: ComputeField[] = [
    {
...
export const SCOPE1_TABS: SubTabConfig[] = [
    ...
    },
    {
        ...
        chartTargetKey: 'Sludge Produced per wastewater treatment process (Kg)',
    },
];
